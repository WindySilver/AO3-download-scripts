...
wget -O $1.azw3 https://archiveofourown.$mirror/downloads/$storyid/$1.azw3
echo "AZW3 downloaded. Sleeping."
sleep 10
echo "Sleep done. Downloading EPUB"
wget -O $1.epub https://archiveofourown.$mirror/downloads/$storyid/$1.epub
echo "EPUB downloaded. Sleeping."
sleep 10
echo "Sleep done. Downloading MOBI"
wget -O $1.mobi https://archiveofourown.$mirror/downloads/$storyid/$1.mobi
echo "MOBI downloaded. Sleeping."
sleep 10
echo "Sleep done. Downloading PDF"
wget -O $1.pdf https://archiveofourown.$mirror/downloads/$storyid/$1.pdf
echo "PDF downloaded. Sleeping."
sleep 10
echo "Sleep done. Downloading HTML"
wget -O $1.html https://archiveofourown.$mirror/downloads/$storyid/$1.html
